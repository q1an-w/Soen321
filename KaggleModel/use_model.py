...
model_path = os.path.join(script_dir, "fraud_model_dt.pkl")  # Load the decision tree model
scaler_path = os.path.join(script_dir, "scaler.pkl")

model = joblib.load(model_path)  # Load the DecisionTreeClassifier model
...
fraud_prob_ambiguous = predict_fraud(example_ambiguous)
fraud_prob_fraudulent = predict_fraud(example_fraudulent)
fraud_prob_real = predict_fraud(example_real)
